                ...
                <div style={{
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: "1rem", flexWrap: "nowrap" }}>
                    <button
                      ...
                      style={{
                        background: isPlayingAudio ? "rgba(255, 94, 98, 0.15)" : "var(--accent-color)",
                ...
                {showSettings && (
                  <div style={{
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                      ...
                      <div style={{ display: "inline-flex", background: "var(--primary-background-color)", borderRadius: "6px", overflow: "hidden", border: "1px solid var(--transparent-light-color)", alignSelf: "flex-start" }}>
                        {["small", "medium", "large", "xlarge"].map((sz) => (
                          <button
                            ...
                            title={`Font size: ${sz}`}
                            style={{
                              background: fontSize === sz ? "rgba(255,255,255,0.08)" : "transparent",
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                      ...
                      <div style={{ display: "inline-flex", background: "var(--primary-background-color)", borderRadius: "6px", overflow: "hidden", border: "1px solid var(--transparent-light-color)", alignSelf: "flex-start" }}>
                        <button
                          ...
                          style={{
                            background: fontFamily === "serif" ? "rgba(255,255,255,0.08)" : "transparent",
                        ...
                        <button
                          ...
                          style={{
                            background: fontFamily === "sans" ? "rgba(255,255,255,0.08)" : "transparent",
                    ...
                    return (
                      <span 
                        ...
                        style={{ 
                          display: "inline", 
                          paddingRight: "4px",
                          background: isSpeaking ? "rgba(250, 214, 72, 0.25)" : undefined,
